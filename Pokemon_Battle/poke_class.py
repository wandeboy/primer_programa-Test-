...
class Gastly(Pokemon):
    ...
    SP_DEF = 55
    atk1 = atk_class.Hex()
    atk2 = atk_class.Shadowpunch()
    atk3 = atk_class.MoongeistBeam()
    atk4 = atk_class.Phantomforce()
    SPEED = 100
    LVL = 50
    ELEMENT_TYPE = 'ghost'
    default_name = 'Gastly'
...
class Geodude(Pokemon):
    ...
    SP_ATK = 45
    SP_DEF = 50
    atk1 = atk_class.Rockblast()
    atk2 = atk_class.Ancientpower()
    atk3 = atk_class.Powergem()
    atk4 = atk_class.Stoneedge()
    SPEED = 40
    LVL = 50
    ELEMENT_TYPE = 'rock'
...
class Machop(Pokemon):
    ...
    SP_ATK = 49
    SP_DEF = 55
    atk1 = atk_class.Karatechop()
    atk2 = atk_class.Secretsword()
    atk3 = atk_class.Vacuumwave()
    atk4 = atk_class.Sacredsword()
    SPEED = 5
    LVL = 50
    ELEMENT_TYPE = 'fight'
    default_name = 'Machop'
